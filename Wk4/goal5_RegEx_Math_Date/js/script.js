...
*/
    ...
    var email = new RegExp('/(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/');
...
*/
    ...
    var clean = str.replace(/(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/g,"XXX@XXX.com");  // g= global parameter
    console.log(clean);
...
*/
  ...
  /*  console.log(d.getDate());
    ...
    console.log(d.getTime()); //number of milliseconds since 1/1/70
// date()
// getFullYear()
// setFullYear()
// getHours()
