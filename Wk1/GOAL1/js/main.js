...
console.log("Sum of numbers in array: ", myArray[0] + myArray[1] + myArray[2] + myArray[3]);
...
console.log(myArry[0] + ', ' + myArry[1] + ', ' + myArry[2]);
...
console.log('bobsMood is ', bobsMood);
...
var counter = myCounter(5);
console.log('counter = ', counter);

var counter = myCounter(2);
console.log('counter = ', counter);
